...
d3.json("https://raw.githubusercontent.com/cchinchristopherj/Holiday-Routes/master/us-states.json", function(json) {
    $( function() {
    ...
    svg1 = d3.select("#svg_map");
    svg2 = d3.select("#svg_chart");
    ...
    d3.csv("https://raw.githubusercontent.com/cchinchristopherj/Holiday-Routes/master/airports_lat_long.csv",function(rawData_coords){
        ...
        d3.csv("https://raw.githubusercontent.com/cchinchristopherj/Holiday-Routes/master/routes_data.csv",function(rawData_routes){
            // Reformat raw data
